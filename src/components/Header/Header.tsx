        ...
        <>
            <header className="header">
                <div className="header_main-infos-container">
                    <h1 className="header_main-name">Bhoomi Verma</h1>
                    <h2 className="header_main-position">
                        Aspiring Software Developer.
                    </h2>
                </div>
                <section className="header_icons-sound-container">
                    <button
                    ...
                    >
                        <img
                            ...
                            alt="Open or close contact menu"
                ...
                {showContact && (
                    ...
                    >
                        <ul className="contact-menu-items">
                            <li
                                className="contact-menu-item"
                                onMouseEnter={playHoverSound}
                            >
                                <a
                                    href="https://mail.google.com/mail/?view=cm&fs=1&to=vermabhoomi183@gmail.com"
                                    target="_blank"
                            ...
                            >
                                <a
                                    href="https://www.linkedin.com/in/bhoomi-verma-67aa54315/"
                                    target="_blank"
                                    className="header_link"
                                >
                                    <button className="header_buttons-menu">
                            ...
                            >
                                <a
                                    href="https://github.com/Bhoomiverma23"
                                    target="_blank"
                                    className="header_link"
                                >
                                    <button className="header_buttons-menu">
